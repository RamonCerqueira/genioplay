      ...
      <Link href="/" className="mb-10 flex flex-col items-center gap-4 group relative z-10">
        <div className="relative">
          <img
            ...
            alt="GênioPlay Logo"
            className="w-16 h-16 object-contain rounded-[1.4rem] overflow-hidden bg-blue-600 shadow-2xl shadow-blue-500/40 group-hover:scale-110 transition-transform duration-500"
          />
