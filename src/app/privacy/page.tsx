...
const sections = {
  ...
  cookies: {
    ...
    content: [
      ...
      { h: "3. Cookies de Desempenho", p: "Utilizamos ferramentas anôniamas para entender como os pais utilizam o site e melhorar continuamente a interface." }
    ]
  }
};
...
function LegalContent() {
  ...
  const [activeTab, setActiveTab] = useState<TabType>(tabParam || 'privacy');
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen transition-colors duration-500">
      ...
      <main className="pt-40 pb-20 px-6">
        <Suspense fallback={<div className="p-20 text-center font-black">Carregando Termos...</div>}>
          <LegalContent />
        </Suspense>
      </main>
      <LandingFooter />
